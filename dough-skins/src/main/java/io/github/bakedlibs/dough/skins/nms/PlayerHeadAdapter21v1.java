...
class PlayerHeadAdapter21v1 implements PlayerHeadAdapter {
    ...
    PlayerHeadAdapter21v1() throws NoSuchMethodException, SecurityException, ClassNotFoundException, UnknownServerVersionException {
    ...
    public void setGameProfile(Block block, GameProfile profile, boolean sendBlockUpdate) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        if (sendBlockUpdate) {
            block.getState(true).update(true, false);
        }
    }
